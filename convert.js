...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Parse XML tags — much more robust than JSON for code content
    const extractedCode = extractTag(raw, "code");
    const bottlenecks = extractBottlenecks(raw);
